...
namespace DbRepository.Migrations
{
    ...
    [Migration("20210225091701_UserRolesRelations")]
    partial class UserRolesRelations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbModels.UserRolesList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DbModels.UserRole", b =>
                {
                    b.HasOne("DbModels.RoleGroup", null)
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleGroupId");

                    b.HasOne("DbModels.UserRolesList", "Role")
                        .WithMany()
